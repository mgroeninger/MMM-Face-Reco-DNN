...
Module.register('MMM-Face-Reco-DNN',
{
	...
	logout_user: function(name)
	{
		...
		if (this.users.includes(name))
		{
			...
			this.config.debug && Log.log(this.userClasses);
			var oldUserClasses = Object.assign(
			{}, this.userClasses); // assign works doing a shallow copy because the object is simply enough
	...
	socketNotificationReceived: function(notification, payload)
	{
		...
		{
			this.config.debug && Log.log('motion notification received')
